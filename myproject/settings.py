...
SECRET_KEY = 'django-insecure-#q_ycoa76)3w3o%1^bxgk^$jdkolq&(#anxdhp5f1(8g&d5+on'
...
# Channel layer settings (use Redis for production)
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
            "hosts": [config('REDIS_URL')],  # Use Render's Redis instance
        },
    },
}
